...
object PecsStore {
    ...
    fun populate() {
        ...
        addItem("Food", Pecs("Vegetables", R.drawable.apple, R.raw.one00001))
        addItem("Food", Pecs("Fruits", R.drawable.fruit_infused, R.raw.one00001))

        addItem("Snacks", Pecs("Chocolate", R.drawable.apple, R.raw.one00001))
        addItem("Snacks", Pecs("French Fries", R.drawable.apple, R.raw.one00001))
        addItem("Snacks", Pecs("Candy", R.drawable.apple, R.raw.one00001))
        addItem("Snacks", Pecs("Popcorn", R.drawable.apple, R.raw.one00001))

        addItem("Places", Pecs("Mcdonald's", R.drawable.apple, R.raw.one00001))
        addItem("Places", Pecs("Home", R.drawable.apple, R.raw.one00001))
        addItem("Places", Pecs("School", R.drawable.apple, R.raw.one00001))
        addItem("Places", Pecs("Nana Car", R.drawable.apple, R.raw.one00001))
        addItem("Places", Pecs("Amma Car", R.drawable.apple, R.raw.one00001))
        addItem("Places", Pecs("Office", R.drawable.apple, R.raw.one00001))
        addItem("Places", Pecs("Shop", R.drawable.apple, R.raw.one00001))
        addItem("Places", Pecs("Gym", R.drawable.apple, R.raw.one00001))

        addItem("Items", Pecs("Lego", R.drawable.apple, R.raw.one00001))
